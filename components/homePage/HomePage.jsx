  ...
  return (
    <div className="flex flex-col space-y-10 md:space-y-0 md:space-x-5 md:flex-row justify-start items-start w-[90%] h-[1020px] md:h-[80vh] my-5 bg-white mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-center max-w-7xl mx-auto w-full h-[550px] p-5">
        <div className="hidden relative md:block w-full md:w-2/3 h-full">
          <Image
            alt="home"
            src={homePage}
            fill
        ...
        <div className="flex flex-col justify-center items-center md:items-start w-full md:w-1/3 h-full space-y-7 md:pl-10">
          ...
          <p className="text-gray-400 text-md font-semibold text-center md:text-left">
            ...
            consequatur consectetur esse et non rem veniam aspernatur atque,
            quam a blanditiis nostrum illum error dolore quis? Ut corrupti
            commodi ex.
          </p>
          <Link
            href="/transactions"
